    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addBtn.setOnClickListener(v -> {
            ...
            if (num1Text.isEmpty() || num2Text.isEmpty()) {
                Toast.makeText(MainActivityLinear.this, "Enter Valid Numbers!", Toast.LENGTH_LONG).show();
                return;
            }
            ...
            try {
                ...
                Toast.makeText(MainActivityLinear.this, "Result = " + result, Toast.LENGTH_LONG).show();
            }
